...
export default function Hero() {
  ...
  const fullText = "Дизайнер инфографики"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <h1 className="text-4xl md:text-6xl font-bold mb-4">
              Привет, я <span className="text-primary">Кристина Довгань</span>
            </h1>
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-lg">
              Создаю продающие карточки и инфографику для маркетплейсов — Wildberries, Ozon, Яндекс Маркет.
              Помогаю товарам выделяться и продавать больше.
            </p>
